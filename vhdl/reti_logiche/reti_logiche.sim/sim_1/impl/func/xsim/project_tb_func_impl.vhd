...
--               logiche/progetto/vhdl/reti_logiche/reti_logiche.sim/sim_1/impl/func/xsim/project_tb_func_impl.vhd}
...
entity project_reti_logiche is
  ...
  attribute ECO_CHECKSUM of project_reti_logiche : entity is "81809785";
...
architecture STRUCTURE of project_reti_logiche is
  ...
  signal cnt : STD_LOGIC_VECTOR ( 2 downto 1 );
  ...
  signal \cnt_reg[2]_i_5_n_0\ : STD_LOGIC;
  ...
  signal \currentAddress[15]_i_9_n_0\ : STD_LOGIC;
  ...
  signal \NLW_bestDistance_reg[8]_i_3_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 2 downto 0 );
  signal \NLW_bestDistance_reg[8]_i_3_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal \NLW_currentAddress_reg[11]_i_1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 2 downto 0 );
  signal \NLW_currentAddress_reg[15]_i_3_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal \NLW_currentAddress_reg[3]_i_1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 2 downto 0 );
  signal \NLW_currentAddress_reg[7]_i_1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 2 downto 0 );
  signal \NLW_outMask_reg[7]_i_6_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal \NLW_outMask_reg[7]_i_6_O_UNCONNECTED\ : STD_LOGIC_VECTOR ( 3 downto 0 );
  signal \NLW_temp1_reg[0]_i_1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 2 downto 0 );
  signal \NLW_temp1_reg[8]_i_2_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 2 downto 0 );
  ...
  signal \NLW_temp2_reg[0]_i_1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 2 downto 0 );
  signal \NLW_temp2_reg[8]_i_3_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 2 downto 0 );
  ...
  signal \NLW_tempDistance_reg[3]_i_1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 2 downto 0 );
  signal \NLW_tempDistance_reg[7]_i_1_CO_UNCONNECTED\ : STD_LOGIC_VECTOR ( 2 downto 0 );
  ...
  attribute SOFT_HLUTNM of \cnt[2]_i_6\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \cnt[2]_i_9\ : label is "soft_lutpair3";
  attribute SOFT_HLUTNM of \currentAddress[15]_i_6\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \currentAddress[15]_i_9\ : label is "soft_lutpair7";
  attribute SOFT_HLUTNM of \maskPos[2]_i_3\ : label is "soft_lutpair10";
  attribute SOFT_HLUTNM of \maskPos[2]_i_5\ : label is "soft_lutpair1";
...
\bestDistance_reg[8]_i_3\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(2 downto 0) => \NLW_bestDistance_reg[8]_i_3_CO_UNCONNECTED\(2 downto 0),
      CYINIT => '0',
...
\cnt[2]_i_7\: unisim.vcomponents.LUT6
    generic map(
...
\cnt_reg[2]_i_5\: unisim.vcomponents.MUXF7
     port map (
      I0 => \cnt[2]_i_7_n_0\,
      I1 => \cnt[2]_i_8_n_0\,
...
\currentAddress[15]_i_8\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00000002"
    )
        port map (
...
\currentAddress[15]_i_9\: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
...
\currentAddress_reg[11]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(2 downto 0) => \NLW_currentAddress_reg[11]_i_1_CO_UNCONNECTED\(2 downto 0),
      CYINIT => '0',
...
\currentAddress_reg[15]_i_3\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(3 downto 0) => \NLW_currentAddress_reg[15]_i_3_CO_UNCONNECTED\(3 downto 0),
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
...
\currentAddress_reg[3]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(2 downto 0) => \NLW_currentAddress_reg[3]_i_1_CO_UNCONNECTED\(2 downto 0),
      CYINIT => '0',
      DI(3 downto 2) => B"00",
...
\currentAddress_reg[7]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(2 downto 0) => \NLW_currentAddress_reg[7]_i_1_CO_UNCONNECTED\(2 downto 0),
      CYINIT => '0',
      DI(3 downto 0) => B"0000",
...
\maskPos[2]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"0000FFFF0000A8AA"
    )
        port map (
      I0 => state(0),
      I1 => \cnt_reg_n_0_[2]\,
...
\maskPos[2]_i_6\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"00040000"
    )
        port map (
...
\outMask_reg[7]_i_6\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(2) => eqOp,
      CO(1 downto 0) => \NLW_outMask_reg[7]_i_6_CO_UNCONNECTED\(1 downto 0),
      CYINIT => '1',
      DI(3 downto 0) => B"0000",
...
\temp1_reg[0]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(2 downto 0) => \NLW_temp1_reg[0]_i_1_CO_UNCONNECTED\(2 downto 0),
      CYINIT => '1',
...
\temp1_reg[8]_i_2\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(2 downto 0) => \NLW_temp1_reg[8]_i_2_CO_UNCONNECTED\(2 downto 0),
      CYINIT => '0',
...
\temp2_reg[0]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(2 downto 0) => \NLW_temp2_reg[0]_i_1_CO_UNCONNECTED\(2 downto 0),
      CYINIT => '1',
...
\temp2_reg[8]_i_3\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(2 downto 0) => \NLW_temp2_reg[8]_i_3_CO_UNCONNECTED\(2 downto 0),
      CYINIT => '0',
...
\tempDistance_reg[3]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(2 downto 0) => \NLW_tempDistance_reg[3]_i_1_CO_UNCONNECTED\(2 downto 0),
      CYINIT => '0',
...
\tempDistance_reg[7]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      CO(2 downto 0) => \NLW_tempDistance_reg[7]_i_1_CO_UNCONNECTED\(2 downto 0),
      CYINIT => '0',
